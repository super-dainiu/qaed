function [Q, T] = iqrq_cpp(H, rtol, verbose, progress_bar) %#ok<INUSD>
% IQRQ_CPP Drop-in replacement for IQRQ backed by the C++ core (qaed_mex).
% Same signature as IQRQ; VERBOSE and PROGRESS_BAR are accepted but ignored.
...
[Qw, Qx, Qy, Qz, Tw, Tx, Ty, Tz] = qaed_mex('iqr', w, x, y, z, rtol);
