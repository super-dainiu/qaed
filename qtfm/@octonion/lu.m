...
% Copyright © 2010, 2011, 2022 Stephen J. Sangwine and Nicolas Le Bihan.
...
for j = 1:N
    ...
    % make any difference with real octonion matrices because there are no
    % divisors of zero.
    ...
    % octonion array A yields a real result, so the code will work for
    % complexified arrays.
